    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12 mb-4 ">
            <div class="d-flex justify-content-center">
                <h4 class="card-title " style="font-weight:600;font-size:30px"><span style="color:rgb(22, 129, 13)">
                        Completed Orders :</span>

                    <span style="color:rgb(61, 7, 75)"> List</span>
                </h4>
                        ...
                        <table class="tablesaw no-wrap v-middle table-hover table" data-tablesaw>
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-0 text-muted fw-normal">Delivery Status</th>
