...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="widget-content searchable-container list">
                ...
                <div class="row justify-content-center align-items-center g-3">
                    ...
                    <div class="col-md-6 col-xl-4">
                        <form class="position-relative">
                            <input type="text" class="form-control  px-4 py-3 shadow-sm" id="input-search"
            ...
            <div class="card card-body">
                <h4 class="text-center mb-4 fw-bold" style="font-size:30px; color:red">Packages History of </h4>
                <h5 class="text-center mb-4 fw-semibold" style="font-size:20px; color:black">{{ $sender->email ?? '' }}</h5>
                            ...
                            @if ($orders && count($orders) > 0)
                                @foreach ($orders as $order)
                                    <tr class="order-row" data-order-number="{{ $order->order_number }}">
                                        ...
                                        <td>
                                            <button type="button"
                                                class="btn btn-sm btn-light-success text-primary custom-size py-3 w-100"
                                        ...
                                        <td>
                                            ...
                                            @elseif($order->package_status == 'HELD BY CUSTOMS')
                                                <span class="shipment-badge badge bg-success px-2 py-4 w-100"
                                                    ...
                                                    <i class="fas fa-pause-circle"
                                                        style="margin-right:5px;margin-left:5px;"></i> HELD BY CUSTOMS
                                                </span>
                                            ...
                                            @else
                                                <span
                                                    class="shipment-badge badge square-badge bg-secondary px-2 py-4 w-100">
                                        ...
                                        <td>
                                            @php
                                                $surveyExists = \App\Models\SurveyFeedback::where(
                                                    'order_pickup_id',
                                                    $order->id,
                                                )->exists();
                                            @endphp
                                            @if (!$surveyExists)
                                                ...
                                                <button type="button" class="shipment-badge badge bg-success py-3 w-100"
                                                    ...
                                                    style="background-color: rgb(83, 36, 15)!important; text-decoration: none; border: none;">
                                            ...
                                            @else
                                                ...
                                                <button type="button" class="shipment-badge badge bg-primary py-3 w-100"
                                                  onclick="window.location.href='{{ route('user.survey.view', $order->id) }}'"
                            ...
                            @else
                                <tr>
                                    <td colspan="9" class="text-center">
                                        <h5 class="text-danger py-4 fw-bold">No orders found.</h5>
                                    </td>
                                </tr>
                            @endif
                        </tbody>
