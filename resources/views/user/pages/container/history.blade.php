...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-12 col-12 align-self-center">
            <h3 class="text-themecolor mb-0">Containers History</h3>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item">
                    <a href="javascript:void(0)">Home</a>
                </li>
                <li class="breadcrumb-item active">Containers History</li>
            </ol>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 mb-5">
                <form method="GET" action="{{ route('user.container.history') }}">
                ...
                @if (request('search'))
                <a href="{{ route('user.container.history') }}"
                        ...
                        <div class="row mt-3">
                            @foreach($paginatedContainers  as $container)
                                <div class="col-3 mb-3">
                                    <a href="{{ route('user.container.details', ['id' => $container->id]) }}" class="text-center rounded-3 border py-3 d-block">                                        <i class="mdi mdi-folder display-6 text-warning"></i>
