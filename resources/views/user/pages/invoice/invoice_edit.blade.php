                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <span class="input-group-text fixed-width" id="orderNumberSpan"
                                                style="background-color:#17a8ad;color:white;font-size:20px;">{{ $orderDetails->order_number }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <span class="input-group-text fixed-width" id="basic-addon1"
                                                ...
                                                {{ \Carbon\Carbon::parse($orderDetails->issue_date)->format('d M Y') }}</span>
                                        </div>
                                    </div>
                                </div>
                                {{-- <div class="col-md-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <span class="input-group-text fixed-width" id="container_id"
                                                style="background-color:#17ad30;color:white;font-size:20px;">{{ $orderDetails->container_number }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <span class="input-group-text fixed-width" id="basic-addon1"
                                                style="background-color:#ff7300;color:white;font-size:20px;">{{ $orderDetails->driver_pickup_name }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="senderLastName" name="senderLastName"
                                                    class="form-control" value="{{ $orderDetails->sender->last_name }}"
                                                    readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" id="senderEmail" name="senderEmail"
                                                    class="form-control" value="{{ $orderDetails->sender->email }}"
                                                    readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="address" name="address" class="form-control"
                                                    value="{{ $orderDetails->sender->street_address }}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="apt" name="apt" class="form-control"
                                                    value="{{ $orderDetails->sender->apt }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="city" name="city" class="form-control"
                                                    value="{{ $orderDetails->sender->city }}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="state" name="state" class="form-control"
                                                    value="{{ $orderDetails->sender->state }}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="zip" name="zip" class="form-control"
                                                    value="{{ $orderDetails->sender->zip }}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="senderTel" name="senderTel"
                                                    class="form-control"
                                                    value="{{ $orderDetails->sender->telephone }}"readonly>
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="senderCell">Cell:</label>
                                                <input type="text" id="senderCell" name="senderCell"
                                                    class="form-control"
                                                    value="{{ $orderDetails->sender->cell }}"readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 ">
                                            <div class="mb-3 mt-4">
                        ...
                        <section>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="shippingPolicy" name="shippingPolicy" class="form-control" rows="4" required></textarea>
    ...
    <script>
        $(document).ready(function() {
            $('#editSenderBtn').on('click', function() {
                ...
                // Fetch values from the form and set them in the modal fields
                $('#editSenderId').val($('#senderId').val());
                $('#editSenderName').val($('#senderName').val());

                $('#editSenderLastName').val($('#senderLastName').val());
                $('#editSenderEmail').val($('#senderEmail').val());
                $('#editAddress').val($('#address').val());
                $('#editApt').val($('#apt').val());
                $('#editCity').val($('#city').val());
                $('#editState').val($('#state').val());
                $('#editZip').val($('#zip').val());
                $('#editSenderTel').val($('#senderTel').val());
                $('#editSenderCell').val($('#senderCell').val());
            });
        });
    </script>
    <script>
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response.status === 'success') {
                                        ...
                                        'validation_error') {
                                        // If validation failed, show the specific validation errors
                                        let validationErrors = response
                                            .errors; // Assuming your backend returns errors in this format
                                        let errorMessage =
                                            'Please correct the following errors:\n\n';
