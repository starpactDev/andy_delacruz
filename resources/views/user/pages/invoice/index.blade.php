                            ...
                            <div class="col-sm-12">
                                <div class="important-note" style="margin-top:35px">
                                    ...
                                    <ul class="important-notes-list-1">
                                        ...
                                        <li> We thank you if you save your invoice for future claims or inconveniences.
                                        </li>
                                        <li>If you pay immediately, you will be one of the first customers to receive
                                            your
                                            merchandise.</li>
                                        <li> We pay 5% on the declared value</li>
                                        <li> Any UNPAID package that remains in our warehouse in the Dominican Republic
                                            for
                                    ...
                                    <ul class="important-notes-list-1">
                                        <li><strong>Receiving Cargo:</strong>
                                            <ul>
                                                <li>At the time of receiving cargo, the consignee must check it to make
                                                    sure
                                                    that everything is okay. He or she must sign a document and, as soon
                                                    as
                                                    the consignee signs such document, neither the exporter nor the
                                                    consignee will have any rights to complain for lost or damaged
                                                    items.
                                                </li>
                                                <li>Any cargo with balance left more than fifteen days in our warehouse
                                                    will
                                                    be charged a 5% of the freight charge every fifteen days. If the
                                                    company
                                                    does not receive any payments during the next three months, the
                                                    customer
                                                    will lose the cargo, and the company will reserve the rights to do
                                                    anything with it.</li>
                                                <li>The company is not responsible for any illegal items contained in
                                                    the
                                                    packages.</li>
                                            </ul>
                                        </li>
                                        <li><strong>NOTE:</strong> The company agrees to pay for the articles in case of
                                            ...
                                            <ul>
                                                <li>To new articles, a 10% of the value of the freight is charged as an
                                                    additional insurance policy. In case of loss or irreparable damage,
                                                    the
                                                    client will receive payment of the total value of the good in the
                                                    market
                                                    as new. The client must show the original receipt from the store
                                                    where
                                                    it was purchased.</li>
                                                <li>To used articles, a 5% of the value of the freight is charged as an
                                                    additional insurance policy. In case of loss or irreparable damage,
                                                    the
                                                    client will receive payment of 25% of the value of the article in
                                                    the
                                                    market.</li>
                                        ...
                                        <li><strong>CLAIMS:</strong>
                                            <ul>
                                                <li>We only accept claims at the time of receiving the cargo. After
                                                    items
                                                    have been received, in case damage has occurred it will only be
                                                    replaced
                                                    if such damage cannot be repaired. The company will not replace the
                                                    item
                                        ...
                                        <li><strong>BOXES OF PERSONAL BELONGINGS:</strong>
                                            <ul>
                                                <li>Must be 18”X18”X28”. In these boxes, new articles are not accepted
                                                    ...
                                                    commercial use.</li>
                                                <li>In case of loss of a box of personal belongings, the company will
                                                    pay a
                                                    maximum of $100.00 dollars per box after an investigation has been
                                                    made,
                                                    and a credit will be given for another box of the same dimensions
                                                    (18”X18”X28”).</li>
                                                <li>The same clauses apply to boxes of used clothes. Jewelry or cell
                                                    phones
                                        ...
                                        <li><strong>DELIVERY OF BOXES:</strong>
                                            <ul>
                                                ...
                                                <li>The boxes must have a security seal from the company when the
                                                    consignee
                                                    is going to receive it. If the invoice has detailed items, the
                                                    representative will open the boxes in the presence of the consignee
                                                    and
                                                    check that all the items listed on the invoice are physically
                                                    present.
                                                    If no items are detailed on the invoice, the representative will
                                                    deliver
                                                    the sealed box.</li>
                                                <li>The consignee of the cargo must be in full mental and physical
                                                    condition
                                                    to receive the cargo; otherwise, the company will not be
                                                    responsible.
                                                </li>
                                            </ul>
                                        </li>
                                        <li><strong>SHIPMENT OF VEHICLES:</strong>
                                            <ul>
                                                <li>Pickup: The company will charge for the pickup of the vehicle
                                                    depending
                                                    on its location. The charge is for the use of the transportation
                                                    plate.
                                                </li>
                                                <li>If the vehicle breaks down along the way to the port, the customer
                                                    will
                                                    be responsible for the costs of towing or any other expense related
                                                    to
                                        ...
                                        <li><strong>CLAIMS FOR VEHICLES:</strong>
                                            <ul>
                                                <li>The company is just an intermediary between the client and the
                                                    shipping
                                                ...
                                                <li>The shipping company is responsible for any damage to the vehicles
                                                    during transportation. The company will assist the client in filing
                                                    the
                                        ...
                                        <li><strong>GENERAL LIABILITY:</strong>
                                            <ul>
                                                <li>The company is not responsible for any delays caused by customs
                                                    procedures, port congestion, strikes, weather conditions, or any
                                                    other
                                                    circumstances beyond the company’s control.</li>
                                                <li>The company reserves the right to refuse any cargo that does not
                                                    comply
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="contact-info">
                                    <div class="signature-row">
                                        <div class="signature-container">
                                            @php
                                                if ($orderDetails && $orderDetails->signatureSender) {
                                                    $signatureImagePath = asset(
                                                        'sender_signatures/' .
                                                            $orderDetails->signatureSender->signature_image,
                                                    );
                                                }
                                            @endphp
                                        ...
                                        {{-- <div class="signature-container">
                                        <div class="signature-line">
                                            <img src="{{ url('/') }}/invoice/assets/img/sign.png"
