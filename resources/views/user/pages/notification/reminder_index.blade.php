                        ...
                        <tbody>
                            @foreach ($notes as $note)
                                <tr class="search-items">
                                    ...
                                    <td> <a href="{{ route('driver.invoice.pdf_index', ['order_number' => $note->order_number]) }}"
                                            target="_blank">View PDF</a>
                                    </td>
                                    <td><span class="paid-badge badge bg-info px-2 py-1">{{ \Carbon\Carbon::parse($note->created_at)->format('d M Y') }}</span></td>
                                    ...
                                    <td>
                                        <div >
                                            {{-- <a href="javascript:void(0)" class="text-info edit"><i data-feather="eye"
                                                    ...
                                                    data-id="{{ $note->id }}"
                                                    data-url="{{ route('driver.notes.destroy', $note->id) }}">
